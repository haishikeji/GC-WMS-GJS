<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作仓库" align="center" prop="ware" min-width="100" fixed />
      <el-table-column label="名称" align="center" prop="mat" min-width="150" fixed />
      <el-table-column label="物料规格" align="center" prop="spec" min-width="100" />
      <el-table-column label="单位" align="center" prop="unit" min-width="100" />
      <el-table-column label="单位标准重量" align="center" prop="perWeight" min-width="100">
        <template slot-scope="{row}">
          {{ row.perWeight.toFixed(6) }}
        </template>
      </el-table-column>
      <el-table-column label="退库件数" align="center" prop="qty" min-width="100" />
      <el-table-column label="成品件数" align="center" prop="totalWeight" min-width="100" />
      <el-table-column label="成品重量" align="center" prop="qty" min-width="100">
        <template slot-scope="{row}">
          {{ row.qty.toFixed(6) }}
        </template>
      </el-table-column>
      <el-table-column label="废花件数" align="center" prop="outor01" min-width="100" />
      <el-table-column label="废白件数" align="center" prop="voucherNo" min-width="100" />
