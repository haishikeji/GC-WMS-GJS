<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="queryForm.outor01Id" class="filter-item" placeholder="出库人" clearable filterable>
    ...
    >
      ...
      <el-table-column label="下道仓库" align="center" prop="nextWare" min-width="100" fixed />
      ...
      <el-table-column label="样币名称" align="center" prop="proofCoin" min-width="100" />
      <el-table-column label="样币件数" align="center" prop="proofCoinQty" min-width="100" />
      <el-table-column label="出库人" align="center" min-width="150">
        <template slot-scope="{row}">
          <span>
            {{ row.outor01 }}
...
<script>
import { listPruduct, expPruduct } from '@/api/sib/subwareOut'
