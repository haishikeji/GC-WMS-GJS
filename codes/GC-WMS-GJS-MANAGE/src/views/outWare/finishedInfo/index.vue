<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-select v-model="queryForm.wareId" class="filter-item" placeholder="待入成品库" disabled>
        <el-option
          v-for="item in productWareOpt"
          :key="item.id"
          :label="item.name"
          :value="item.id"
        />
...
export default {
  ...
  created() {
    this.queryForm.wareId = 13
    this.getProductWareOpt() // 产品库
    this.getDictOptList('markOpt')
    this.getDictOptList('logoOpt')
    this.getList()
  },
  mounted() {},
  methods: {
