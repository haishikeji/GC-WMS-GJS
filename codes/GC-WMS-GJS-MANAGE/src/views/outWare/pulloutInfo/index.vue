<template>
  <div class="app-container">
    ...
    <Edit
      ...
      :put-apart-opt="putApartOpt"
      @initParam="initParam"
    />
    <!-- 查询-->
    <div class="filter-container">
      <el-select v-model="queryForm.wareId" class="filter-item" placeholder="当前操作仓库" clearable @change="handleChange">
        <el-option
    ...
    <div class="filter-container sub-title">
      请选择要出库的物料
    </div>
    <!-- 物料信息表列表 -->
    <el-table row-key="id" :data="tableData" :header-cell-style="{ background: '#eef1f6', color: '#606266' }" border stripe fit highlight-current-row>
      ...
      <el-table-column label="标识" align="center" prop="totalWeight" min-width="100" />
...
export default {
  ...
  methods: {
    ...
    handleSelect(row) {
      ...
      this.$set(this.editForm, 'isNeedProofCoin', '2')
